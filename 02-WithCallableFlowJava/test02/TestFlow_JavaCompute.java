...
public class TestFlow_JavaCompute extends MbJavaComputeNode 
{
	  public void evaluate(MbMessageAssembly inAssembly) throws MbException 
	  {
	    ...
	    try {
	      ...
	      try
	      {
	    	  String failValue = (String)(inputLE.getFirstElementByPath("HTTP/Input/QueryString").getLastChild().getValue());
	    	  if ( failValue.equals("true") )
	    	  {
	    		  System.out.println("Setting fail=true");
	    		  fail = true;
	    	  }
	      } catch ( java.lang.Throwable jlt ) {
		        //jlt.printStackTrace();
